...
void selfTestPending() {
  ...
  display.drawRect(0, 42, 128, 10, KS0108_ON);
...
void FiftyHz() {
  ...
  display.drawRect(0, 54, 64, 10, KS0108_ON);
  display.display(); // Update screen with each newly-drawn rectangle
...
void empty_box_Downside() {
  ...
  display.drawRect(64, 54, 64, 10, KS0108_ON);
  display.display(); // Update screen with each newly-drawn rectangle
...
void battery_icon() {
  ...
  display.drawRect(85, 56, 15, 7, KS0108_ON);
  display.display(); // Update screen with each newly-drawn rectangle
...
// Battery charge rect with rounded and empty
  ...
  display.fillRoundRect(85, 56, 10, 7, 1, KS0108_ON);
  display.display();
